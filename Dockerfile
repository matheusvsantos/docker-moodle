...
FROM ubuntu:16.04
MAINTAINER Matheus Veleci <matheusveleci@gmail.com>
#Contributor Maintainer Alessandra de Melo <ale.melo95@gmail.com>
...
# Install Mod_CustomCertificate Plugin
RUN cd /var/www/html/mod && \
		wget -qO- -O tmp.zip https://moodle.org/plugins/download.php/13158/mod_customcert_moodle32_2016120504.zip && \
		unzip tmp.zip && \
		rm tmp.zip
